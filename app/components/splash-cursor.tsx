...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function compileShader(
      ...
      if (!shader) throw new Error("WebGL 셰이더 생성 실패");
    ...
    function createProgram(
      ...
      if (!program) throw new Error("WebGL 프로그램 생성 실패");
    ...
    let dye: ReturnType<typeof createDoubleFBO> | undefined;
    let velocity: ReturnType<typeof createDoubleFBO> | undefined;
    let divergence: ReturnType<typeof createFBO> | undefined;
    let curl: ReturnType<typeof createFBO> | undefined;
    let pressure: ReturnType<typeof createDoubleFBO> | undefined;
    ...
    function resizeFBO(
      target: ReturnType<typeof createFBO>,
      w: number,
      h: number,
      internalFormat: any,
      format: any,
    ...
    function render(target: ReturnType<typeof createFBO> | null) {
      gl.blendFunc(gl.ONE, gl.ONE_MINUS_SRC_ALPHA);
      gl.enable(gl.BLEND);
      drawDisplay(target);
    }

    function drawDisplay(target: ReturnType<typeof createFBO> | null) {
      if (!dye) return;
